...
- Name: truthtrail.spec.ts >> TruthTrail Rendering >> should render dynamic values from IntelligenceOutput without hardcoding
- Location: tests/e2e/truthtrail.spec.ts:4:7
